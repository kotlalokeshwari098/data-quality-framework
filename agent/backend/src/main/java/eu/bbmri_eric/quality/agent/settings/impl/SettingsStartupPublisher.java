...
public class SettingsStartupPublisher {
  ...
  public SettingsStartupPublisher(
      SettingsService settingsService, ApplicationEventPublisher eventPublisher) {
  ...
  public void publishSettingsOnStartup() {
    ...
    eventPublisher.publishEvent(new SettingsUpdatedEvent(this, settings));
  }
}
